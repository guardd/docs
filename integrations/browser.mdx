...
If risk &ge; 0.6 (high), a warning banner appears:
...
If risk &ge; 0.8 (critical), prompt submission is blocked:
...
| Critical | &ge; 0.8 | ⛔ Dark Red | Block |
...
<ParamField path="show_suggestions" type="boolean" default="true">
...
<ParamField path="desktop_notifications" type="boolean" default="false">
Show desktop notifications for high-risk prompts

Default: `false`
</ParamField>

<ParamField path="sound_alerts" type="boolean" default="false">
Play sound for critical-risk prompts

Default: `false`
</ParamField>

<ParamField path="log_prompts" type="boolean" default="true">
...
<ParamField path="enabled_platforms" type="array" default='["gemini", "claude", "chatgpt"]'>
Which AI platforms to monitor

Options: `"gemini"`, `"claude"`, `"chatgpt"`
</ParamField>

<ParamField path="auto_block" type="boolean" default="true">
Automatically block critical-risk prompts

Default: `true`
</ParamField>

<ParamField path="require_justification" type="boolean" default="false">
...
Access at: [app.orcho.ai/compliance](https://app.orcho.ai/compliance)
...
- Contact support@orcho.ai with examples
</Accordion>
...
Configure at: [app.orcho.ai/rules](https://app.orcho.ai/rules)
...
| Arc | All | ✅ Fully supported |
| Firefox | - | ⚠️ Coming soon |
