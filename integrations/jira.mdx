...
For high-risk tickets (&ge; 0.6), stakeholders are automatically notified
</Step>
...
2. If risk &ge; 0.6 → Status changes to "Security Review"
...
**Workflow:**
1. Ticket created → Risk assessed
2. If risk &ge; 0.8 → Status changes to "Blocked - Critical Risk"
...
<ParamField path="warning_threshold" type="number" default="0.6">
Risk score that triggers warnings and notifications

Default: `0.6` (high risk)
</ParamField>

<ParamField path="blocking_threshold" type="number" default="0.8">
Risk score that blocks ticket from moving to development

Default: `0.8` (critical risk)
</ParamField>

<ParamField path="auto_approve_threshold" type="number" default="0.4">
...
<ParamField path="notify_high_risk" type="boolean" default="true">
Send notifications for high-risk tickets (&ge; 0.6)
</ParamField>

<ParamField path="notify_critical_risk" type="boolean" default="true">
Send notifications for critical-risk tickets (&ge; 0.8)
</ParamField>
...
**Connection Errors:**
- Verify Jira can reach api.orcho.ai
