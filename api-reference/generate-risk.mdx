...
api: "POST /api/risk/v1/generate-risk"
---
...
<ParamField body="weights" type="object">
  ...
  <Expandable title="Weight Configuration">
    ...
    <ParamField body="weights.blast_radius" type="number">
      Weight for blast radius score (0-1, requires context)
    </ParamField>
...
url = 'https://api.orcho.ai/risk/api/v1/generate-risk'
headers = {
...
<AccordionGroup>
  ...
  <Accordion title="Custom weights">
    Adjust weights based on your use case and risk tolerance. Weights are subject to your implementation requirements.
